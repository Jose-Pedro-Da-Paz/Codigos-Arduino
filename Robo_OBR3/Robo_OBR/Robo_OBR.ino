...
void loop() { 
 ...
 /* if((distancia <= 8)&&(distancia >= 4)){
  ...
  if((valorIRE2==0)&&(valorIRE==0)&&(valorIRF==0)&&(valorIRD==0)&&(valorIRD2==0)){
   ...
   if((valorIRE2==0)&&(valorIRE==0)&&(valorIRF==1)&&(valorIRD==0)&&(valorIRD2==0)){
    frente();
   }
   if((valorIRE2==1)&&(totalE>=650)){
    frente();
    delay(800);
    esquerdaforte();
    delay(800);
  ...
  if((valorIRE2==0)&&(valorIRE==0)&&(valorIRF==0)&&(valorIRD==1)&&(valorIRD2==0)){
    direita(); 
    delay(100);
     
  }
   if((valorIRD2==1)&&(totalD>=650)){
    frente();
    delay(800);
    direitaforte();
    delay(800);
  ...
  if((valorIRD2==1)&&(valorIRE2==0)&&(valorIRE==0)&&(totalD<=650)){
    frente();
    delay(800);
    direitaforte();
    delay(800);
  ...
  if((valorIRE2==1)&&(valorIRE==1)&&(valorIRF==1)&&(valorIRD==1)&&(valorIRD2==1)){
    frente();
    delay(200);
  }
